...
<div id="content">
  ...
  <table>
    <form id="form" name="form" method="post" action="index.php?page=adminmodules">
      ...
      <tr>
        ...
        <td class="odd">
          <button class="adminsettings_bouton" type="submit" name="displayTopPanelSlider" value="<?php echo $webui_admin_settings_activate_bouton; ?>"><?php echo $webui_admin_settings_activate_bouton; ?></button>
        </td>
        ...
        <td class="odd">
          <button class="adminsettings_bouton" type="submit" name="displayTopPanelSlider" value="<?php echo $webui_admin_settings_desactivate_bouton; ?>"><?php echo $webui_admin_settings_desactivate_bouton; ?></button>
        </td>
          <? } ?>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td class="even">
          <button class="adminsettings_bouton"  type="submit" name="displayTemplateSelector" value="<?php echo $webui_admin_settings_activate_bouton; ?>"><?php echo $webui_admin_settings_activate_bouton; ?></button>
        </td>
        ...
        <td class="even">
          <button class="adminsettings_bouton"  type="submit" name="displayTemplateSelector" value="<?php echo $webui_admin_settings_desactivate_bouton; ?>"><?php echo $webui_admin_settings_desactivate_bouton; ?></button>
        </td>
          <? } ?>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td class="odd">
          <button class="adminsettings_bouton" type="submit" name="displayStyleSwitcher" value="<?php echo $webui_admin_settings_activate_bouton; ?>"><?php echo $webui_admin_settings_activate_bouton; ?></button>
        </td>
        ...
        <td class="odd">
          <button class="adminsettings_bouton" type="submit" name="displayStyleSwitcher" value="<?php echo $webui_admin_settings_desactivate_bouton; ?>"><?php echo $webui_admin_settings_desactivate_bouton; ?></button>
        </td>
          <? } ?>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td class="even">
          <button class="adminsettings_bouton" type="submit" name="displayStyleSizer" value="<?php echo $webui_admin_settings_activate_bouton; ?>"><?php echo $webui_admin_settings_activate_bouton; ?></button>
        </td>
        ...
        <td class="even">
          <button class="adminsettings_bouton" type="submit" name="displayStyleSizer" value="<?php echo $webui_admin_settings_desactivate_bouton; ?>"><?php echo $webui_admin_settings_desactivate_bouton; ?></button>
        </td>
          <? } ?>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td class="odd">
          <button class="adminsettings_bouton" type="submit" name="displayFontSizer" value="<?php echo $webui_admin_settings_activate_bouton; ?>"><?php echo $webui_admin_settings_activate_bouton; ?></button>
        </td>
        ...
        <td class="odd">
          <button class="adminsettings_bouton" type="submit" name="displayFontSizer" value="<?php echo $webui_admin_settings_desactivate_bouton; ?>"><?php echo $webui_admin_settings_desactivate_bouton; ?></button>
        </td>
          <? } ?>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td class="even">
          <button class="adminsettings_bouton" type="submit" name="displayLanguageSelector" value="<?php echo $webui_admin_settings_activate_bouton; ?>"><?php echo $webui_admin_settings_activate_bouton; ?></button>
        </td>
        ...
        <td class="even">
          <button class="adminsettings_bouton" type="submit" name="displayLanguageSelector" value="<?php echo $webui_admin_settings_desactivate_bouton; ?>"><?php echo $webui_admin_settings_desactivate_bouton; ?></button>
        </td>          
          <? } ?>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td class="odd">
          <button class="adminsettings_bouton" type="submit" name="displayScrollingText" value="<?php echo $webui_admin_settings_activate_bouton; ?>"><?php echo $webui_admin_settings_activate_bouton; ?></button>
        </td>
        ...
        <td class="odd">
          <button class="adminsettings_bouton" type="submit" name="displayScrollingText" value="<?php echo $webui_admin_settings_desactivate_bouton; ?>"><?php echo $webui_admin_settings_desactivate_bouton; ?></button>
        </td>          
          <? } ?>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td class="even">
          <button class="adminsettings_bouton" type="submit" name="displayWelcomeMessage" value="<?php echo $webui_admin_settings_activate_bouton; ?>"><?php echo $webui_admin_settings_activate_bouton; ?></button>
        </td>
        ...
        <td class="even">
          <button class="adminsettings_bouton" type="submit" name="displayWelcomeMessage" value="<?php echo $webui_admin_settings_desactivate_bouton; ?>"><?php echo $webui_admin_settings_desactivate_bouton; ?></button>
        </td>          
          <? } ?>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td class="odd">
          <button class="adminsettings_bouton" type="submit" name="displayLogo" value="<?php echo $webui_admin_settings_activate_bouton; ?>"><?php echo $webui_admin_settings_activate_bouton; ?></button>
        </td>
        ...
        <td class="odd">
          <button class="adminsettings_bouton" type="submit" name="displayLogo" value="<?php echo $webui_admin_settings_desactivate_bouton; ?>"><?php echo $webui_admin_settings_desactivate_bouton; ?></button>
        </td>          
          <? } ?>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td class="even">
          <button class="adminsettings_bouton" type="submit" name="displayLogoEffect" value="<?php echo $webui_admin_settings_activate_bouton; ?>"><?php echo $webui_admin_settings_activate_bouton; ?></button>
        </td>
        ...
        <td class="even">
          <button class="adminsettings_bouton" type="submit" name="displayLogoEffect" value="<?php echo $webui_admin_settings_desactivate_bouton; ?>"><?php echo $webui_admin_settings_desactivate_bouton; ?></button>
        </td>          
          <? } ?>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td class="odd">
          <button class="adminsettings_bouton" type="submit" name="displaySlideShow" value="<?php echo $webui_admin_settings_activate_bouton; ?>"><?php echo $webui_admin_settings_activate_bouton; ?></button>
        </td>
        ...
        <td class="odd">
          <button class="adminsettings_bouton" type="submit" name="displaySlideShow" value="<?php echo $webui_admin_settings_desactivate_bouton; ?>"><?php echo $webui_admin_settings_desactivate_bouton; ?></button>
        </td>          
          <? } ?>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td class="even">
          <button class="adminsettings_bouton" type="submit" name="displayMegaMenu" value="<?php echo $webui_admin_settings_activate_bouton; ?>"><?php echo $webui_admin_settings_activate_bouton; ?></button>
        </td>
        ...
        <td class="even">
          <button class="adminsettings_bouton" type="submit" name="displayMegaMenu" value="<?php echo $webui_admin_settings_desactivate_bouton; ?>"><?php echo $webui_admin_settings_desactivate_bouton; ?></button>
        </td>          
          <? } ?>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td class="odd">
          <button class="adminsettings_bouton" type="submit" name="displayDate" value="<?php echo $webui_admin_settings_activate_bouton; ?>"><?php echo $webui_admin_settings_activate_bouton; ?></button>
        </td>
        ...
        <td class="odd">
          <button class="adminsettings_bouton" type="submit" name="displayDate" value="<?php echo $webui_admin_settings_desactivate_bouton; ?>"><?php echo $webui_admin_settings_desactivate_bouton; ?></button>
        </td>          
          <? } ?>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td class="even">
          <button class="adminsettings_bouton" type="submit" name="displayTime" value="<?php echo $webui_admin_settings_activate_bouton; ?>"><?php echo $webui_admin_settings_activate_bouton; ?></button>
        </td>
        ...
        <td class="even">
          <button class="adminsettings_bouton" type="submit" name="displayTime" value="<?php echo $webui_admin_settings_desactivate_bouton; ?>"><?php echo $webui_admin_settings_desactivate_bouton; ?></button>
        </td>          
          <? } ?>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td class="odd">
          <button class="adminsettings_bouton" type="submit" name="displayRoundedCorner" value="<?php echo $webui_admin_settings_activate_bouton; ?>"><?php echo $webui_admin_settings_activate_bouton; ?></button>
        </td>
        ...
        <td class="odd">
          <button class="adminsettings_bouton" type="submit" name="displayRoundedCorner" value="<?php echo $webui_admin_settings_desactivate_bouton; ?>"><?php echo $webui_admin_settings_desactivate_bouton; ?></button>
        </td>
          <? } ?>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td class="even">
          <button class="adminsettings_bouton" type="submit" name="displayBackgroundColorAnimation" value="<?php echo $webui_admin_settings_activate_bouton; ?>"><?php echo $webui_admin_settings_activate_bouton; ?></button>
        </td>
        ...
        <td class="even">
          <button class="adminsettings_bouton" type="submit" name="displayBackgroundColorAnimation" value="<?php echo $webui_admin_settings_desactivate_bouton; ?>"><?php echo $webui_admin_settings_desactivate_bouton; ?></button>
        </td>
          <? } ?>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td class="odd">
          <button class="adminsettings_bouton" type="submit" name="displayPageLoadTime" value="<?php echo $webui_admin_settings_activate_bouton; ?>"><?php echo $webui_admin_settings_activate_bouton; ?></button>
        </td>
        ...
        <td class="odd">
          <button class="adminsettings_bouton" type="submit" name="displayPageLoadTime" value="<?php echo $webui_admin_settings_desactivate_bouton; ?>"><?php echo $webui_admin_settings_desactivate_bouton; ?></button>
        </td>
          <? } ?>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td class="even">
          <button class="adminsettings_bouton" type="submit" name="displayW3c" value="<?php echo $webui_admin_settings_activate_bouton; ?>"><?php echo $webui_admin_settings_activate_bouton; ?></button>
        </td>
        ...
        <td class="even">
          <button class="adminsettings_bouton" type="submit" name="displayW3c" value="<?php echo $webui_admin_settings_desactivate_bouton; ?>"><?php echo $webui_admin_settings_desactivate_bouton; ?></button>
        </td>
          <? } ?>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td class="odd">
          <button class="adminsettings_bouton" type="submit" name="displayRss" value="<?php echo $webui_admin_settings_activate_bouton; ?>"><?php echo $webui_admin_settings_activate_bouton; ?></button>
        </td>
        ...
        <td class="odd">
          <button class="adminsettings_bouton" type="submit" name="displayRss" value="<?php echo $webui_admin_settings_desactivate_bouton; ?>"><?php echo $webui_admin_settings_desactivate_bouton; ?></button>
        </td>
          <? } ?>
        </td>
      </tr>
